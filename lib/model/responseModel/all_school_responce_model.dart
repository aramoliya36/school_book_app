...
//
//     final allSchoolResponse = allSchoolResponseFromJson(jsonString);

import 'dart:convert';

AllSchoolResponse allSchoolResponseFromJson(String str) =>
    AllSchoolResponse.fromJson(json.decode(str));

String allSchoolResponseToJson(AllSchoolResponse data) =>
...
class AllSchoolResponse {
  ...
  factory AllSchoolResponse.fromJson(Map<String, dynamic> json) =>
      AllSchoolResponse(
        status: json["status"],
