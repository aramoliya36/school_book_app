...
PurchaseHistoryResponse purchaseHistoryResponseFromJson(String str) =>
    PurchaseHistoryResponse.fromJson(json.decode(str));

String purchaseHistoryResponseToJson(PurchaseHistoryResponse data) =>
